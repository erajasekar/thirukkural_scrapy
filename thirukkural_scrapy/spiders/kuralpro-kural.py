...
class KuralproSpider(scrapy.Spider):
    ...
    def getUrls(self):
        ...
        for favKural in favKurals:
         ...
         #   print (adhigaramIndex)
            ...
            urls.append(url);
        print ("Input Count : " + str(len(urls)));
        return urls;
    ...
    def parse(self, response):
        ...
        print ("SUCCESS = " + str(self.success))
            ...
            ## FAiled https://kural.pro/tamil/thirukkural-706-kuripparidhal_1 ; https://kural.pro/tamil/thirukkural-283-kallaamai_1 ; https://kural.pro/tamil/thirukkural-286-kallaamai_1